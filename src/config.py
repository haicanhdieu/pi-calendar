...
COLOR_BAR_PANEL_RGB = (0x14, 0x14, 0x14)
COLOR_PRESS_FLASH_RGB = (0xFF, 0xE9, 0xB8)
...
COLOR_BAR_PANEL = rgb888_to_rgb565(*COLOR_BAR_PANEL_RGB)
COLOR_PRESS_FLASH = rgb888_to_rgb565(*COLOR_PRESS_FLASH_RGB)
