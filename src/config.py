...
FONT_SETTINGS_REBOOT = "settings_reboot"
...
FONT_SCALE_SETTINGS_REBOOT = 2  # ~14 px (16 px cell height)
SETTINGS_REBOOT_LETTER_SPACING_PX = 2
SETTINGS_REBOOT_LABEL = "REBOOT"
SETTINGS_MODE_LABEL = "SETTING MODE"
...
FONT_SCALES = {
    ...
    FONT_SETTINGS_STATUS: 2,  # 16 px
    FONT_SETTINGS_GUIDELINE: 1,  # 8 px
    FONT_SETTINGS_REBOOT: FONT_SCALE_SETTINGS_REBOOT,
}
...
CALENDAR_CLOCK_BOX_PADDING_X_PX = 4
CALENDAR_CLOCK_BOX_PADDING_Y_PX = 2
